        ...
        <Column className="flex flex-col justify-start max-w-[1011px] sm:mb-[3px] md:mb-[5px] mb-[6px] ml-[auto] sm:mr-[3px] md:mr-[5px] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-end ml-[auto] sm:mt-[39px] md:mt-[51px] mt-[60px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[92%]">
                    ...
                    <Column className="flex flex-col justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] w-[100%]">
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[71%]">
                        ...
                        <Column className="flex flex-col justify-start md:ml-[34px] ml-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[60%]">
                          <Button
                            className="flex items-center justify-center min-w-[82%] text-center w-[max-content]"
                          ...
                          <Text
                            className="font-bold leading-[normal] sm:mt-[5px] md:mt-[6px] mt-[8px] text-red_500 w-[100%]"
                            variant="body3"
                          >
                            密碼長度必須 6-12 碼，包含英
                            <br />
            ...
            <Img
              ...
              className="sm:h-[24px] md:h-[31px] h-[35px] max-w-[100%] sm:ml-[65px] md:ml-[84px] ml-[98px] sm:mt-[590px] md:mt-[763px] mt-[887px] sm:w-[23px] md:w-[30px] w-[35px]"
              alt="question"
            />
          </Row>
        </Column>
