                    ...
                    <Column className="flex flex-col justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] w-[100%]">
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[21px] md:mt-[27px] mt-[32px] w-[100%]">
                        ...
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[83%]">
                          ...
                          ></SelectBox>
                          <Text
                            className="bg-white_A700 border border-gray_401 border-solid font-bold md:pl-[13px] pl-[16px] md:pr-[30px] pr-[35px] sm:px-[15px] sm:py-[5px] md:py-[7px] py-[9px] rounded-radius8 text-bluegray_900 w-[80px]"
                            variant="body3"
                          >
                            1鄰
                          </Text>
