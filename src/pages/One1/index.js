...
const One1Page = () => {
  ...
  return (
    <>
      <Column
        className="common-pointer bg-white_A700 flex flex-col font-notosanstc items-end justify-start mx-[auto] sm:p-[15px] md:p-[33px] p-[39px] w-[100%]"
      ...
      >
        <Column className="flex flex-col justify-start max-w-[1012px] sm:mb-[3px] md:mb-[5px] mb-[6px] ml-[auto] sm:mr-[3px] md:mr-[4px] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <Column className="flex flex-col justify-start md:ml-[70px] ml-[82px] sm:mt-[29px] md:mt-[37px] mt-[44px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[92%]">
            <Column className="bg-blue_50 flex flex-col items-end justify-start sm:mx-[0] sm:pl-[15px] md:pl-[34px] pl-[40px] sm:py-[15px] md:py-[34px] py-[40px] rounded-radius16 sm:w-[100%] w-[86%]">
              <Column className="flex flex-col justify-start sm:mb-[12px] md:mb-[16px] mb-[19px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[90%]">
                <Text className="text-black_900 w-[auto]" as="h5" variant="h5">
                  健保卡讀取確認
                </Text>
                <Column className="flex flex-col font-notosanssc items-center justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[79%]">
