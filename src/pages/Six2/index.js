                ...
                <Column className="bg-blue_50 flex flex-col items-center justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] sm:p-[15px] md:p-[34px] p-[40px] rounded-radius8 w-[100%]">
                  <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                    ...
                    <Column className="flex flex-col justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] w-[100%]">
                      <List
                        className="sm:gap-[21px] md:gap-[27px] gap-[32px] grid min-h-[auto] sm:w-[100%] w-[71%]"
                        orientation="vertical"
                      >
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start md:mr-[32px] mr-[38px] sm:mx-[0] my-[0] sm:px-[0] sm:w-[100%] w-[89%]">
                          ...
                          <Column className="flex flex-col justify-start md:ml-[34px] ml-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[55%]">
                            <Column className="bg-white_A700 border border-gray_401 border-solid flex flex-col items-center justify-start p-[10px] sm:p-[6px] md:p-[8px] rounded-radius8 w-[100%]">
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[97%]">
                                <Text
                                  className="flex-grow font-bold mt-[3px] text-bluegray_900 md:tracking-ls1 sm:tracking-ls1 tracking-ls14000000000000001"
                                  variant="body3"
                                >
                                  ming_23
                                </Text>
                                <Img
                                  ...
                                  className="common-pointer flex-shrink-0 sm:h-[14px] md:h-[18px] h-[20px] max-w-[100%] sm:w-[13px] md:w-[17px] w-[20px]"
                        ...
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between my-[0] w-[100%]">
                          ...
                          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[61%]">
                            <Column className="bg-white_A700 border border-gray_401 border-solid flex flex-col items-center sm:mx-[0] p-[10px] sm:p-[6px] md:p-[8px] rounded-radius8 sm:w-[100%] w-[81%]">
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[97%]">
                                <Text
                                  className="flex-grow font-bold mt-[3px] text-bluegray_900 md:tracking-ls1 sm:tracking-ls1 tracking-ls14000000000000001"
                                  variant="body3"
                                ...
                                <Img
                                  src="images/img_eye.svg"
                                  className="flex-shrink-0 sm:h-[14px] md:h-[18px] h-[20px] max-w-[100%] sm:w-[13px] md:w-[17px] w-[20px]"
                                  alt="eye One"
                                />
                              </Row>
                            </Column>
                        ...
                        <Line className="self-center w-[100%] mt-[32px] sm:mt-[21px] sm:px-[0] md:mt-[27px] justify-between items-center flex-row flex" />
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between my-[0] sm:px-[0] w-[100%]">
                          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[28%]">
                            <Text
                              className="font-bold sm:mb-[4px] md:mb-[6px] mb-[7px] text-red_500 w-[auto]"
                              as="h6"
