    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-notosanstc items-center justify-end mx-[auto] sm:pt-[15px] md:pt-[33px] pt-[39px] w-[100%]">
        <Column className="flex flex-col justify-start w-[100%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[412px] md:ml-[82px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Img
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end max-w-[926px] ml-[auto] mr-[auto] sm:mt-[22px] md:mt-[29px] mt-[34px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            ...
            <Img
              ...
              className="sm:h-[24px] md:h-[31px] h-[35px] max-w-[100%] ml-[101px] sm:ml-[67px] md:ml-[86px] sm:mt-[440px] md:mt-[568px] mt-[661px] sm:w-[23px] md:w-[30px] w-[35px]"
              alt="question"
            />
          </Row>
          <footer className="bg-bluegray_900 font-roboto sm:mt-[19px] md:mt-[25px] mt-[30px] w-[100%]">
