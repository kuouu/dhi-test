          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end ml-[auto] sm:mt-[39px] md:mt-[51px] mt-[60px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[92%]">
            <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[86%]">
              ...
              <Column className="flex flex-col items-center justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] w-[100%]">
                ...
                <Column className="bg-blue_50 flex flex-col items-center justify-end sm:mt-[26px] md:mt-[34px] mt-[40px] sm:p-[15px] md:p-[32px] p-[38px] rounded-radius8 w-[100%]">
                  <Column className="flex flex-col justify-start sm:mt-[3px] md:mt-[5px] mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[65%]">
                    <Text
                    ...
                    <Column className="flex flex-col justify-end sm:mt-[26px] md:mt-[34px] mt-[40px] sm:pt-[3px] md:pt-[4px] pt-[5px] w-[100%]">
                      ...
                      <Column className="flex flex-col items-center justify-start sm:mt-[24px] md:mt-[31px] mt-[37px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[16%]">
                        <Text
                          className="font-bold text-black_900 w-[auto]"
                          variant="body1"
                        >
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start mr-[auto] sm:mt-[20px] md:mt-[26px] mt-[31px] sm:mx-[0] pt-[4px] sm:px-[0] sm:w-[100%] w-[68%]">
                        <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[17%]">
                          <Text
                            className="font-bold text-black_900 w-[auto]"
                            variant="body1"
                          >
