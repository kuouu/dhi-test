      ...
      <Column className="bg-white_A700 flex flex-col font-notosanstc items-end justify-start mx-[auto] sm:p-[15px] md:p-[33px] p-[39px] w-[100%]">
        <Column className="flex flex-col justify-start max-w-[1012px] sm:mb-[3px] md:mb-[5px] mb-[6px] ml-[auto] sm:mr-[3px] md:mr-[4px] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <Column className="flex flex-col justify-start md:ml-[70px] ml-[82px] sm:mt-[29px] md:mt-[37px] mt-[44px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[92%]">
            <Column className="bg-blue_50 flex flex-col items-center justify-start sm:mx-[0] sm:p-[15px] md:p-[34px] p-[40px] rounded-radius16 sm:w-[100%] w-[86%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-center sm:mb-[12px] md:mb-[16px] mb-[19px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[80%]">
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between w-[100%]">
                      <Stack className="bg-light_blue_100 h-[192px] md:p-[10px] p-[12px] sm:p-[7px] relative rounded-radius8 sm:w-[100%] w-[59%]">
                        ...
                        >
                          <Column className="flex flex-col justify-start sm:mb-[15px] md:mb-[20px] mb-[24px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[84%]">
                            ...
                            <Column className="flex flex-col justify-start md:ml-[17px] ml-[20px] sm:mt-[25px] md:mt-[33px] mt-[39px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
                              ...
                              <Text
                                className="ml-[1px] mt-[3px] text-black_900 tracking-ls08 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                                variant="body5"
                              >
                                99 / 11 / 22
                              </Text>
                        ...
                        <Row className="absolute bottom-[11%] flex flex-row md:flex-wrap sm:flex-wrap inset-x-[0] items-start sm:mx-[0] mx-[auto] sm:px-[0] sm:w-[100%] w-[90%]">
                          ...
                          />
                          <Img
                            src="images/img_videocamera_3.svg"
                      ...
                      <Column className="flex flex-col font-notosanstc items-end justify-start sm:mt-[30px] md:mt-[39px] mt-[46px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[27%]">
                        <Column className="flex flex-col items-center justify-start w-[100%]">
                          <Button
                        ...
                        <Column className="flex flex-col items-center justify-start sm:mt-[17px] md:mt-[22px] mt-[26px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%]">
                          <a
                            href={"javascript:"}
                ...
                <Column className="flex flex-col items-center justify-start md:ml-[14px] ml-[17px] md:mt-[107px] mt-[125px] sm:mt-[83px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[4%]">
                  <Img
                  ...
                  <Img
                    src="images/img_checkmark_22X22.svg"
                    className="sm:h-[15px] md:h-[19px] h-[22px] max-w-[100%] sm:mt-[24px] md:mt-[31px] mt-[37px] sm:w-[14px] md:w-[18px] w-[22px]"
                    alt="checkmark One"
                  />
                </Column>
              </Row>
