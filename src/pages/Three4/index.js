          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end ml-[auto] sm:mt-[39px] md:mt-[51px] mt-[60px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[92%]">
            <Column className="flex flex-col items-center justify-start sm:mb-[19px] md:mb-[25px] mb-[30px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[86%]">
              ...
              <Column className="flex flex-col items-center justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] w-[100%]">
                ...
                <Column className="bg-blue_50 flex flex-col items-center justify-end sm:mt-[26px] md:mt-[34px] mt-[40px] p-[108px] sm:p-[15px] md:p-[92px] rounded-radius8 w-[100%]">
                  <Column className="flex flex-col items-center justify-start sm:mt-[3px] md:mt-[5px] mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[68%]">
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[26px] md:mt-[34px] mt-[40px] w-[100%]">
                      <Text
                      ...
                      <Input
                        className="common-pointer font-bold p-[0] text-[14px] placeholder:text-bluegray_900 text-bluegray_900 w-[100%]"
                        wrapClassName="sm:mx-[0] sm:w-[100%] w-[79%]"
                        type="email"
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mt-[26px] md:mt-[34px] mt-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[56%]">
                    <Button
