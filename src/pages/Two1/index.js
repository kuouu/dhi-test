          ...
          <Column className="flex flex-col justify-start md:ml-[70px] ml-[82px] sm:mt-[19px] md:mt-[25px] mt-[30px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[92%]">
            <Column className="bg-blue_50 flex flex-col items-end justify-start sm:mx-[0] sm:pl-[15px] md:pl-[32px] pl-[38px] sm:pt-[15px] md:pt-[32px] pt-[38px] rounded-radius16 sm:w-[100%] w-[86%]">
              <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[82%]">
                ...
                <Column className="flex flex-col justify-start sm:mt-[26px] md:mt-[34px] mt-[40px] sm:pb-[31px] md:pb-[40px] pb-[47px] sm:pr-[15px] md:pr-[40px] pr-[47px] w-[100%]">
                  <Stack className="h-[40px] relative sm:w-[100%] w-[57%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[21px] md:mt-[27px] mt-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[42%]">
                    ...
                    <Text
                      className="bg-white_A700 border border-gray_401 border-solid font-normal sm:ml-[26px] md:ml-[34px] ml-[40px] not-italic sm:pb-[5px] md:pb-[7px] pb-[9px] md:pl-[13px] pl-[16px] md:pr-[30px] pr-[35px] md:pt-[10px] pt-[12px] sm:pt-[7px] sm:px-[15px] rounded-radius8 text-bluegray_900 md:tracking-ls1 sm:tracking-ls1 tracking-ls14000000000000001 w-[160px]"
                      variant="body3"
                    >
                      ●●●●●●●
                    </Text>
