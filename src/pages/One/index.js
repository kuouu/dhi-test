...
const OnePage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 flex flex-col font-notosanstc items-end justify-end mx-[auto] sm:pt-[15px] md:pt-[33px] pt-[39px] sm:px-[15px] md:px-[33px] px-[39px] w-[100%]">
        <Column className="flex flex-col justify-end max-w-[1011px] ml-[auto] sm:mr-[3px] md:mr-[5px] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          <Row
            className="common-pointer flex flex-row md:flex-wrap sm:flex-wrap items-center mr-[auto] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[41%]"
          ...
          <Text
            className="sm:ml-[217px] md:ml-[280px] ml-[326px] sm:mr-[251px] md:mr-[324px] mr-[377px] sm:mt-[22px] md:mt-[29px] mt-[34px] text-indigo_800 w-[auto]"
            as="h4"
            variant="h4"
          >
            註冊健保卡網路服務系統
          </Text>
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:ml-[12px] ml-[15px] sm:mt-[23px] md:mt-[30px] mt-[35px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
            <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
