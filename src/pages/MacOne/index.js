    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-notosanstc items-end justify-start mx-[auto] sm:p-[15px] md:p-[33px] p-[39px] w-[100%]">
        <Column className="flex flex-col justify-start max-w-[1012px] sm:mb-[3px] md:mb-[5px] mb-[6px] ml-[auto] sm:mr-[3px] md:mr-[4px] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <Stack className="h-[64px] md:ml-[104px] ml-[121px] sm:ml-[80px] sm:mt-[24px] md:mt-[31px] mt-[37px] relative sm:w-[100%] w-[71%]">
            ...
            <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap inset-x-[0] items-center sm:mx-[0] mx-[auto] sm:px-[0] top-[23%] sm:w-[100%] w-[80%]">
          ...
          <Column className="flex flex-col justify-start ml-[105px] md:ml-[90px] sm:mt-[21px] md:mt-[28px] mt-[33px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[90%]">
            <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[84%]">
              ...
              <Column className="bg-blue_50 flex flex-col items-center justify-start sm:p-[15px] md:p-[55px] p-[64px] w-[100%]">
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mt-[26px] md:mt-[34px] mt-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[45%]">
                  <Column
                    className="common-pointer bg-indigo_800 flex flex-col items-center sm:mx-[0] p-[10px] sm:p-[6px] md:p-[8px] rounded-radius8 sm:w-[100%] w-[43%]"
